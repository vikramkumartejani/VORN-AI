...
const DePIN = () => {
    ...
    return (
        <I18nextProvider i18n={i18n}>
            ...
            {/* Hero Section */}
            <div className="relative flex flex-col items-center justify-center text-center h-[683px] px-6">
                {/* Background Video */}
                ...
                <div className="max-w-[850px] mx-auto z-20 relative">
                    <h1 className="text-4xl md:text-[54px] leading-[74px] font-bold text-white">
                        DePIN – The Backbone of VORN.AI
                    </h1>
                    <p className="max-w-[665px] mx-auto text-[18px] leading-[30px] font-normal font-poppins text-white mt-[25px]">
                        DePIN in VORN.AI provides the physical resources for the ecosystem, such as computing nodes, storage devices, and energy grids, enabling users to monetize their infrastructure while powering decentralized operations.
                    </p>
                </div>
            </div>
