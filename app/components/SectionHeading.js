...
const SectionHeading = ({
    ...
    return (
        <div className='max-w-[372px] mx-auto justify-center w-full flex items-center gap-4'>
            ...
            >
                ...
                <h2 className='text-nowrap text-[#DDD6FE] text-[13px] leading-[15.74px] font-normal'>{text}</h2>
            </div>
            <Image src={rightArrowSrc} alt='arrow' width={110} height={1} className='rotate-180' />
        </div>
    )
}
