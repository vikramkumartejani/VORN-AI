        ...
        <div className='py-20' style={{ background: `radial-gradient(32.52% 50% at 50% 50%, rgba(132, 45, 255, 0.25) 0%, rgba(2, 1, 3, 0.25) 100%), linear-gradient(0deg, #000000, #000000)` }}>
            <div className='max-w-[1248px] mx-auto w-full'>
                ...
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute right-0 top-0 bottom-0 w-[100px] z-10"
                        style={{ background: "linear-gradient(270deg, #000000 0%, rgba(0, 0, 0, 0) 100%)" }}>
                    </div>
                ...
                <style jsx>{`
                    @keyframes scroll-ltr {
                        ...
                        100% { transform: translateX(calc(-104px * ${logos.length} - 39px * ${logos.length})); }
                    }
                    
                    @keyframes scroll-rtl {
                        0% { transform: translateX(calc(-104px * ${logos.length} - 39px * ${logos.length})); }
