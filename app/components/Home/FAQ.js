      ...
      <div className="max-w-[1090px] mx-auto space-y-4 mt-8 md:mt-[60px]">
        {FAQData.map((faq, index) => {
          ...
          return (
            <div
              key={index}
              className={`rounded-2xl p-[15px] md:px-[36px] md:py-[16px] transition-all duration-500 ease-in-out ${isOpen ? "bg-purple-900/20" : "bg-purple-900/10"
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-2xl transition-opacity duration-300 ${isOpen || "hover:opacity-100"
