  ...
  return (
    <div className="text-center w-full">
      <div className="px-[30px]">
        <h2 className="text-[32px] leading-[38.4px] font-bold text-white">
          {t("home.buyNowBox.title")}{" "}
          <span className="text-[#8E00FF]">$VRN</span> {t("home.buyNowBox.now")}
        </h2>
        <h4 className="text-white/90 text-[14px] leading-[16.8px] font-medium pt-[15px]">
          {t("home.buyNowBox.untilPriceIncrease")}
        </h4>
        {/* Current & Next Price */}
        <div className="mt-5">
          <div className="flex items-center justify-between gap-5">
            <h2 className="text-white/90 text-[14px] leading-[16.8px] font-normal">
          ...
          <h3 className="text-[14px] leading-[16.8px] font-normal text-[#C176FF]">
      ...
      <div className="mt-5 w-full bg-[#7314C040]">
        <div className="max-w-[395px] mx-auto w-full flex items-center gap-[85px] py-2.5">
          <div>
            <h2 className="text-[14px] leading-[16.8px] font-medium mb-[5px]">
              {t("home.buyNowBox.stackableVRN")}
            </h2>
            <h3 className="text-[#C176FF] text-[14px] leading-[16.8px] font-normal">
              44093531
            </h3>
          </div>
      ...
      <div className="px-[30px]">
        ...
        <div className="my-5 border border-[#8616DF] rounded-[9px] p-[5px] flex items-center justify-between">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              className={`h-[50px] w-full rounded-lg flex items-center justify-center gap-2.5 ${
                activeTab === tab.id ? "border border-[#FFFFFF26]" : ""
              }`}
              style={
                activeTab === tab.id
                  ? {
        ...
        <div className="w-full justify-center flex items-center gap-4">
          ...
          >
            <h2 className="text-nowrap text-white text-[14px] leading-[16.8px] font-normal">
        ...
        <div className="mt-5 flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2 items-start w-full">
            <h2 className="text-[14px] leading-[16.8px] font-bold text-white">
            ...
            <div className="w-full h-[50px] rounded-lg border border-[#8616DF] flex items-center justify-between gap-3 pl-4 pr-[5px]">
              <input
                type="text"
                placeholder="0.00"
                className="w-full bg-transparent outline-none placeholder:text-white/80 text-white text-base font-normal"
              />
              ...
              <div ref={dropdownRef} className="relative inline-block">
                {/* Dropdown Button */}
                <div
                  className={`h-10 max-w-[100px] min-w-[94px] flex items-center justify-between px-1.5 py-2 rounded-t-[10px] ${
                    isOpen ? "rounded-b-none" : "rounded-[10px]"
                ...
                >
                  <div className="flex items-center">
                    <Image
                      ...
                      height={22}
                    />
                    <h3 className="text-white text-[14px] leading-[18px] font-normal ml-[4px]">
        ...
        <div className="my-5 space-y-[11px]">
          <h3 className="text-white text-[14px] leading-[16.8px] font-bold text-left">
          ...
          <div className="grid grid-cols-3 gap-[11px]">
            {percentOptions.map((percent) => (
              <button
                key={percent}
                className={`border border-[#8616DF] rounded-lg p-2 text-[14px] leading-[16.8px] font-medium ${
                  activePercent === percent ? "text-white" : "text-white"
                }`}
                style={
          ...
          <p className="text-white/90 text-[14px] font-normal leading-[16.8px] text-left">
        ...
        {/* Buy Now */}
        <button
          className={`${styles.stakingButtonBuyNow} ${
        ...
        <div className="mt-5 flex items-center justify-between gap-3">
          {infoItems.map((item, index) => (
            <div key={index} className="flex items-center gap-2.5">
              ...
              <h3 className="text-white/90 text-[14px] leading-[16.8px] font-normal">
                {item.text}
              </h3>
            </div>
          ))}
